...
2. Upload the `collector` executable you built to somewhere that's visible to your cluster (eg S3).
3. Run `collector` as a task in Marathon, by editing the following JSON config:
