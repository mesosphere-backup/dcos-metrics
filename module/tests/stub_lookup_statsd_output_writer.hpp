...
typedef std::shared_ptr<metrics::StatsdOutputWriter> writer_ptr_t;

class StubLookupStatsdOutputWriter : public metrics::StatsdOutputWriter {
 public:
 ...
 private:
  StubLookupStatsdOutputWriter(
      ...
      boost::system::error_code lookup_error,
      size_t chunk_size = 0,
      size_t chunk_timeout_ms = metrics::StatsdOutputWriter::DEFAULT_CHUNK_TIMEOUT_MS)
    : StatsdOutputWriter(
        io_service,
