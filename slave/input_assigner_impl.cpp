...
stats::InputAssignerImpl::InputAssignerImpl(const mesos::Parameters& parameters)
...
stats::InputAssignerImpl::~InputAssignerImpl() {
...
Try<stats::UDPEndpoint> stats::InputAssignerImpl::register_container(
...
std::list<Try<stats::UDPEndpoint>> stats::InputAssignerImpl::register_containers(
...
void stats::InputAssignerImpl::unregister_container(const mesos::ContainerID& container_id) {
  std::unique_lock<std::mutex> lock(mutex);
...
Try<stats::UDPEndpoint> stats::InputAssignerImpl::get_statsd_endpoint(const mesos::ExecutorInfo& executor_info) {
  std::unique_lock<std::mutex> lock(mutex);
...
void stats::InputAssignerImpl::run_io_service() {
...
stats::SinglePortAssignerImpl::SinglePortAssignerImpl(const mesos::Parameters& parameters)
...
stats::SinglePortAssignerImpl::~SinglePortAssignerImpl() { }

Try<stats::UDPEndpoint> stats::SinglePortAssignerImpl::_register_container(
    const mesos::ContainerID& container_id,
    const mesos::ExecutorInfo& executor_info) {
...
void stats::SinglePortAssignerImpl::_unregister_container(const mesos::ContainerID& container_id) {
  if (!single_port_reader) {
...
Try<stats::UDPEndpoint> stats::SinglePortAssignerImpl::_get_statsd_endpoint(const mesos::ExecutorInfo& executor_info) {
  if (!single_port_reader) {
...
stats::EphemeralPortAssignerImpl::EphemeralPortAssignerImpl(const mesos::Parameters& parameters)
  : InputAssignerImpl(parameters) {
  // No extra params to validate
}
stats::EphemeralPortAssignerImpl::~EphemeralPortAssignerImpl() { }

Try<stats::UDPEndpoint> stats::EphemeralPortAssignerImpl::_register_container(
    const mesos::ContainerID& container_id,
    const mesos::ExecutorInfo& executor_info) {
...
void stats::EphemeralPortAssignerImpl::_unregister_container(const mesos::ContainerID& container_id) {
  auto iter = container_to_reader.find(container_id);
  if (iter == container_to_reader.end()) {
...
Try<stats::UDPEndpoint> stats::EphemeralPortAssignerImpl::_get_statsd_endpoint(const mesos::ExecutorInfo& executor_info) {
...
stats::PortRangeAssignerImpl::PortRangeAssignerImpl(const mesos::Parameters& parameters)
  : InputAssignerImpl(parameters) {
...
stats::PortRangeAssignerImpl::~PortRangeAssignerImpl() { }

Try<stats::UDPEndpoint> stats::PortRangeAssignerImpl::_register_container(
    const mesos::ContainerID& container_id,
    const mesos::ExecutorInfo& executor_info) {
  // Reuse existing reader if available.
  auto iter = container_to_reader.find(container_id);
...
void stats::PortRangeAssignerImpl::_unregister_container(const mesos::ContainerID& container_id) {
  auto iter = container_to_reader.find(container_id);
  if (iter == container_to_reader.end()) {
...
Try<stats::UDPEndpoint> stats::PortRangeAssignerImpl::_get_statsd_endpoint(const mesos::ExecutorInfo& executor_info) {
  auto container_iter = executor_to_container.find(executor_info.executor_id());
  if (container_iter == executor_to_container.end()) {
    std::ostringstream oss;
