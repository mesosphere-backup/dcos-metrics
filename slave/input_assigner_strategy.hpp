...
namespace stats {
  ...
  class InputAssignerStrategy {
   public:
    InputAssignerStrategy() { }
    virtual ~InputAssignerStrategy() { }
   ...
   */
  class SinglePortStrategy : public InputAssignerStrategy {
   public:
    /**
   ...
   */
  class EphemeralPortStrategy : public InputAssignerStrategy {
   public:
   ...
   */
  class PortRangeStrategy : public InputAssignerStrategy {
   public:
    /**
     * Creates an uninitialized instance. init() must be called before anything else.
     */
